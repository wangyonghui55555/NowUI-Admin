...
class NSuperImageModel extends Component {
    constructor (props) {
        super(props);
    ...
    handleClick (fileId) {
        ...
        if (index > -1) {
            ...
            if (activeList.length < this.props.returnLimit) {
    ...
    handleBeforeUpload (file, value) {
        if (this.props.returnLimit < value.length) {
        ...
        return (
            ...
            >
                ...
                <Modal visible={this.state.isPreview}
                    ...
                    <div className="item-image preview-image"
                         style={{backgroundImage: 'url(' + this.state.image + ')'}}></div>
                </Modal>
...
NSuperImageModel.defaultProps = {};

export default NSuperImageModel