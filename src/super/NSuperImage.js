...
import NSuperImageModel from './NSuperImageModel';
...
class NSuperImage extends Component {
    constructor (props) {
        super(props);
    ...
    render () {
        return (
            <Form.Item className="form-item"
                ...
                <NSuperImageModel id={this.props.formItemKey}
...
NSuperImage.defaultProps = {

};

export default NSuperImage;
