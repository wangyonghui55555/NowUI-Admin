...
export default {
   ...
   menuList:[/*{
       ...
       children: [{
           id: '111',
           name: '永辉业务统计管理',
           url: '/yonghui/business/order/index'
       },{
           id: '112',
           name: '美狗平台订单统计管理',
           url: '/order/statistics/index'
       },{
           id: '113',
           name: '差异数据对比',
           url: '/order/statistics/index2'
       },{
           id: '114',
           name: '配送员报表',
           url: '/distribution/statistics/index3'
       }]
   },/*{
        id: '10',
        name: '系统管理',
        ...
        children: [{
            ...
            id: '105',
            name: '角色菜单信息管理',
            url: '/role/menu/map/index'
        },{
            id: '106',
            name: '角色站点信息管理',
            url: '/role/site/map/index'
        }]
    }],*/
       {
           id: '10',
