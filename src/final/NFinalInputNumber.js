...
class NFinalInputNumber extends Component {
    constructor (props) {
        super(props);
        ...
        return (
            <Form.Item
                ...
                {this.props.getFieldDecorator(this.props.formItemKey, {
                    ...
                    initialValue: this.props.formItemInitValue?"underfind":0
                })(
...
NFinalInputNumber.defaultProps = {};

export default NFinalInputNumber