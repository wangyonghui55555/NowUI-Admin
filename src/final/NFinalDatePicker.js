...
class NFinalDatePicker extends Component {
	constructor (props) {
		super(props);
		...
		return (
			<Form.Item
				...
				{this.props.getFieldDecorator(this.props.formItemKey, {
					...
					initialValue: this.props.formItemInitValue === '' ? undefined : this.props.formItemInitValue
				})(
					<DatePicker showTime
...
NFinalDatePicker.defaultProps = {};

export default NFinalDatePicker